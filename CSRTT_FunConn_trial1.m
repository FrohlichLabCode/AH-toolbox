...
elseif cluster == 1
    ...
    GroupAnalysisDir = ['/pine/scr/h/w/angelvv/FerretData/' animalCode '/GroupAnalysis/Spec_premature/'];
...
parfor irec = 1:numel(fileInfo)
    ...
    CSRTT_rec_cluster_1(irec,fileInfo,folderSuffix, PreprocessDir, AnalysisDir, BehavDatDir, GroupAnalysisDir,...
