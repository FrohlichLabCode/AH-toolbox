function funcCon = is_functionalConnectivity(xser,yser,regionXname,regionYname,condName,fs,event,twin, baseTwin, chn1,chn2, saveRootPath, linORlog, lowFreq, highFreq, numFreqs)
...
doPlot = 1;
doGC = 1;
time2save = baseTwin(1):0.02:baseTwin(2); %downsample to 500Hz when save
...
newFs     = 200;    % This is very important for GC! model order = number of time samples put into the sutoregressive model
